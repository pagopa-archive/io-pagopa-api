...
export interface IpspInviaCarrelloRPTCarteInput {
  ...
  importoTotalePagato: number; //TODO [#158031250] wsdl-to-ts fix https://www.pivotaltracker.com/n/projects/2161158/stories/158031250/
...
export interface IPSPPortSoap {
  pspInviaRPT: (
    input: IpspInviaRPTInput,
    cb: (
      err: any | null,
      result: IpspInviaRPTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspInviaCarrelloRPT: (
    input: IpspInviaCarrelloRPTInput,
    cb: (
      err: any | null,
      result: IpspInviaCarrelloRPTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspInviaCarrelloRPTCarte: (
    input: IpspInviaCarrelloRPTCarteInput,
    cb: (
      err: any | null,
      result: IpspInviaCarrelloRPTCarteOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspChiediRT: (
    input: IpspChiediRTInput,
    cb: (
      err: any | null,
      result: IpspChiediRTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspInviaAckRT: (
    input: IpspInviaAckRTInput,
    cb: (
      err: any | null,
      result: IpspInviaAckRTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspChiediAvanzamentoRPT: (
    input: IpspChiediAvanzamentoRPTInput,
    cb: (
      err: any | null,
      result: IpspChiediAvanzamentoRPTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspChiediListaRT: (
    input: IpspChiediListaRTInput,
    cb: (
      err: any | null,
      result: IpspChiediListaRTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspNotificaCancellazioneRPT: (
    input: IpspNotificaCancellazioneRPTInput,
    cb: (
      err: any | null,
      result: IpspNotificaCancellazioneRPTOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspInviaRichiestaStorno: (
    input: IpspInviaRichiestaStornoInput,
    cb: (
      err: any | null,
      result: IpspInviaRichiestaStornoOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
  pspInviaRispostaRevoca: (
    input: IpspInviaRispostaRevocaInput,
    cb: (
      err: any | null,
      result: IpspInviaRispostaRevocaOutput,
      raw: string,
      soapHeader: { [k: string]: any }
    ) => any
  ) => void;
