 ...
 */
export declare function createPagamentiTelematiciPspNodoClient(
 ...
 */
export declare function createIscrizioniAvvisaturaClient(
  options: soap.IOptions
 ...
 */
export declare function createNodoChiediElencoAvvisiDigitaliClient(
  options: soap.IOptions
...
export declare class PagamentiTelematiciPspNodoAsyncClient {
  ...
  ) => Promise<PagamentiTelematiciPspNodoService.InodoVerificaRPTOutput>;
  nodoAttivaRPT: (
    input: PagamentiTelematiciPspNodoService.InodoAttivaRPTInput
  ) => Promise<PagamentiTelematiciPspNodoService.InodoAttivaRPTOutput>;
  nodoInviaRT: (
    input: PagamentiTelematiciPspNodoService.InodoInviaRTInput
  ) => Promise<PagamentiTelematiciPspNodoService.InodoInviaRTOutput>;
  nodoChiediInformativaPA: (
    input: PagamentiTelematiciPspNodoService.InodoChiediInformativaPAInput
  ) => Promise<
    PagamentiTelematiciPspNodoService.InodoChiediInformativaPAOutput
  >;
  nodoChiediTemplateInformativaPSP: (
    input: PagamentiTelematiciPspNodoService.InodoChiediTemplateInformativaPSPInput
  ) => Promise<
    PagamentiTelematiciPspNodoService.InodoChiediTemplateInformativaPSPOutput
  >;
  nodoInviaFlussoRendicontazione: (
    input: PagamentiTelematiciPspNodoService.InodoInviaFlussoRendicontazioneInput
  ) => Promise<
    PagamentiTelematiciPspNodoService.InodoInviaFlussoRendicontazioneOutput
  >;
  nodoChiediElencoQuadraturePSP: (
    input: PagamentiTelematiciPspNodoService.InodoChiediElencoQuadraturePSPInput
  ) => Promise<
    PagamentiTelematiciPspNodoService.InodoChiediElencoQuadraturePSPOutput
  >;
  nodoChiediQuadraturaPSP: (
    input: PagamentiTelematiciPspNodoService.InodoChiediQuadraturaPSPInput
  ) => Promise<
    PagamentiTelematiciPspNodoService.InodoChiediQuadraturaPSPOutput
  >;
  nodoInviaEsitoStorno: (
    input: PagamentiTelematiciPspNodoService.InodoInviaEsitoStornoInput
  ) => Promise<PagamentiTelematiciPspNodoService.InodoInviaEsitoStornoOutput>;
  nodoInviaRichiestaRevoca: (
    input: PagamentiTelematiciPspNodoService.InodoInviaRichiestaRevocaInput
  ) => Promise<
    PagamentiTelematiciPspNodoService.InodoInviaRichiestaRevocaOutput
  >;
}
/**
...
export declare class IscrizioniAvvisaturaAsyncClient {
  ...
  nodoAggiornaIscrizioniAvvisatura: (
    input: IscrizioniAvvisaturaService.InodoAggiornaIscrizioniAvvisaturaInput
  ) => Promise<
    IscrizioniAvvisaturaService.InodoAggiornaIscrizioniAvvisaturaOutput
  >;
}
/**
...
export declare class NodoChiediElencoAvvisiDigitaliAsyncClient {
  ...
  nodoChiediElencoAvvisiDigitali: (
    input: NodoChiediElencoAvvisiDigitaliService.InodoChiediElencoAvvisiDigitaliInput
  ) => Promise<
    NodoChiediElencoAvvisiDigitaliService.InodoChiediElencoAvvisiDigitaliOutput
  >;
}
