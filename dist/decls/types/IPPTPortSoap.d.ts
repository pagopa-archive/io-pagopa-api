...
export interface IPPTPortSoap {
    readonly nodoVerificaRPT: (input: nodoVerificaRPT_ppt, cb: (err: any, result: nodoVerificaRPTRisposta_ppt, raw: string, soapHeader: {
        readonly [k: string]: any;
    }) => any) => void;
    readonly nodoAttivaRPT: (input: nodoAttivaRPT_ppt, cb: (err: any, result: nodoAttivaRPTRisposta_ppt, raw: string, soapHeader: {
        readonly [k: string]: any;
    }) => any) => void;
}
