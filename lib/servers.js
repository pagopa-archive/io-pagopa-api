...
var wsdl_paths = require("./wsdl-paths");
var utils_1 = require("./utils");
// import interface for "PSP" services
var FespPspService = require("../wsdl-lib/FespPspService/PSPPort");
exports.FespPspService = FespPspService;
var AvvisiDigitaliService = require("../wsdl-lib/AvvisiDigitaliService/PPTPort");
...
function attachFespPspServer(server, path, fespPspHandlers) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, utils_1.readWsdl(wsdl_paths.FespPspService_WSDL_PATH)];
                case 1:
                    wsdl = _a.sent();
                    service = {
                        FespPspService: {
                    ...
                    return [2 /*return*/, (soap.listen(server, path, service, wsdl))];
            }
        });
    });
}
...
function attachAvvisiDigitaliServer(server, path, avvisiDigitaliHandlers) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, utils_1.readWsdl(wsdl_paths.AvvisiDigitaliService_WSDL_PATH)];
                case 1:
                    wsdl = _a.sent();
                    service = {
