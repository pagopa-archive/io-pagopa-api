...
export const FespPspService_WSDL_PATH = `${wsdlBaseDir}/nodo/PspPerNodo.wsdl`;
...
export const PagamentiTelematiciPspNodoService_WSDL_PATH = `${wsdlBaseDir}/nodo/NodoPerPsp.wsdl`;
