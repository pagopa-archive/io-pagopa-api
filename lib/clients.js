...
var wsdl_paths = require("../lib/wsdl-paths");
var utils_1 = require("./utils");
// import interfaces for "pagoPA" services (Nodo and Avvisatura)
var PagamentiTelematiciPspNodoService = require("../wsdl-lib/PagamentiTelematiciPspNodoservice/PPTPort");
exports.PagamentiTelematiciPspNodoService = PagamentiTelematiciPspNodoService;
var IscrizioniAvvisaturaService = require("../wsdl-lib/IscrizioniAvvisaturaService/PPTPort");
exports.IscrizioniAvvisaturaService = IscrizioniAvvisaturaService;
var NodoChiediElencoAvvisiDigitaliService = require("../wsdl-lib/NodoChiediElencoAvvisiDigitaliService/PPTPort");
 ...
 */
var PagamentiTelematiciPspNodoAsyncClient = /** @class */ (function () {
    function PagamentiTelematiciPspNodoAsyncClient(client) {
        this.client = client;
    ...
    return PagamentiTelematiciPspNodoAsyncClient;
}());
 ...
 * promise based methods.
 */
var IscrizioniAvvisaturaAsyncClient = /** @class */ (function () {
    function IscrizioniAvvisaturaAsyncClient(client) {
        this.client = client;
        this.nodoAggiornaIscrizioniAvvisatura = utils_1.promisifySoapMethod(this.client.nodoAggiornaIscrizioniAvvisatura);
    }
    return IscrizioniAvvisaturaAsyncClient;
}());
 ...
 */
var NodoChiediElencoAvvisiDigitaliAsyncClient = /** @class */ (function () {
    function NodoChiediElencoAvvisiDigitaliAsyncClient(client) {
        this.client = client;
        this.nodoChiediElencoAvvisiDigitali = utils_1.promisifySoapMethod(this.client.nodoChiediElencoAvvisiDigitali);
    }
    return NodoChiediElencoAvvisiDigitaliAsyncClient;
}());
